...
import com.xing.VO.ProductInfoVO;
import com.xing.VO.ProductVO;
...
public class BuyerProductController {
    ...
    public ResultVO list(){
       //查询所有上架商品
        ...
        //传统方法
       //(ProductInfo productInfo:productInfoList){
       ...
       //
        ...
        for(ProductCategory productCategory: productCategoryList){
            ...
            productVO.setCategoryName(productCategory.getCategoryNme());
