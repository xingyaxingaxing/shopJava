<nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation" style="width: 170px">
    <ul class="nav sidebar-nav" margin-left:-100px style="width: 170px">
        ...
        <li class="dropdown open">
            <a href="#" class="dropdown open" data-toggle="dropdown" aria-expanded="true"><i class="fa fa-fw fa-plus"></i> 商品 <span class="caret"></span></a>
